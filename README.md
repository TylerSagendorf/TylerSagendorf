...
- [High-performance gene set enrichment analysis](https://github.com/pnnl/fast.ssgsea)
  - Highly optimized variant of pre-ranked gene set enrichment analysis (GSEA).
...
- Improved performance of the functions `fsum()` and `fmean()` in the `collapse` R package: [collapse v2.1.7 release notes](https://github.com/fastverse/collapse/releases/tag/v2.1.7).
